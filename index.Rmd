...
If you are following along at home, copy and paste that into your script template chart.html.  You can see mine [here](https://github.com/timelyportfolio/rCharts_d3_horizon/blob/gh-pages/libraries/widgets/d3_horizon/layouts/d3_horizon.html).
...
SP500.df <- cbind(
  format(as.Date(index(SP500.ret)), "%Y-%d-%m"),
  coredata(SP500.ret)
)
